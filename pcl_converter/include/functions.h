...
void getOBB(const pcl::PointCloud<pcl::PointXYZ> &cloud_cluster, vision_msgs::Detection2D &det, const std::vector<double>& Cxy);
vector<double> findClosestPointOnArc(const double& Xcar, const double& Ycar, const std::vector<double>& Cxy);
